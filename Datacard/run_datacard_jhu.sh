...
#        cp $InputTreePathdirectory/Bin$i/ws_GG2HbsmM/output_GluGluHToGGPlusTwoJets_CPodd_M125_TuneCP5_13TeV-amcatnlopowheg-minlo-pythia8_GG2HbsmM.root $InputTreePathdirectory/Bin$i/WS
	...
	cp $InputTreePathdirectory/Bin$i/ws_GG2Hsm/output_JJHiggs0PMToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8_GG2Hsm.root $InputTreePathdirectory/Bin$i/WS
	cp $InputTreePathdirectory/Bin$i/ws_GG2HMf05ph0/output_JJHiggs0Mf05ph0ToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8_GG2HMf05ph0.root $InputTreePathdirectory/Bin$i/WS
	cp $InputTreePathdirectory/Bin$i/ws_GG2HbsmM/output_JJHiggs0MToGG_M125_TuneCP5_13TeV-JHUGenV7011-pythia8_GG2HbsmM.root $InputTreePathdirectory/Bin$i/WS
...
python RunYields.py --inputWSDirMap 2017=$InputTreePathdirectory/Bin$i/WS  --cats AC_Bin$i --batch local --queue hep.q --ext bin$i
