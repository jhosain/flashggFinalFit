...
python /afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Combine/Combine_V8/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat AC_Bin9 --procs auto --ext 2018 --mass 125 --inputWSDirMap 2018=Trees/Opt_2018/2018/Trees2WS_2018/WS --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --doSystematics --ignore-warnings
