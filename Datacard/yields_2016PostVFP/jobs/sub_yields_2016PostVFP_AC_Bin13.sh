...
python /afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Combine/Combine_V8/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat AC_Bin13 --procs auto --ext 2016PostVFP --mass 125 --inputWSDirMap 2016PostVFP=Trees/Opt_2016PostVFP/3D_DCP_CPodd_p25_Bkg_p60_2016PostVFP/Trees2WS_2016PostVFP/WS --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --skipZeroes
