...
python RunYields.py --inputWSDirMap $year=Trees/Opt_$year/$InputTreePathdirectory/Trees2WS_$year/WS --cats auto  --procs auto --batch local --queue hep.q --ext $year $syst --ignore-warnings
