...
python /afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Combine/Combine_V8/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat AC_Bin28 --procs auto --ext 2016postVFP --mass 125 --inputWSDirMap 2016postVFP=Trees/Opt_2016postVFP/2016PostVFP/Trees2WS_2016postVFP/WS --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --doSystematics --ignore-warnings
