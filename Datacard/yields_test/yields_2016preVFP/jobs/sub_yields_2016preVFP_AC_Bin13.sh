...
python /afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Combine/Combine_V8/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat AC_Bin13 --procs auto --ext 2016preVFP --mass 125 --inputWSDirMap 2016preVFP=Trees/Opt_2016preVFP/2016PreVFP/Trees2WS_2016preVFP/WS --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --doSystematics --ignore-warnings
