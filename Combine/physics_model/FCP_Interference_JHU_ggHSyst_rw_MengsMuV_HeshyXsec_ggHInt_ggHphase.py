...
class FCP_Interference_JHU_ggHSyst_rw_MengsMuV_HeshyXsec_ggHInt_ggHphase(PhysicsModel):
    def doParametersOfInterest(self):
        ...
        # Implementing the relation for fCP_Htt according to the inverted formula eq. 11 in ggH_AN
       
        self.modelBuilder.doVar('expr::fa3_ggH("(@0>0 ? 1 : -1)/(1 + (1/2.38)*(1/abs(@0)- 1))", fCP_Htt)') 
