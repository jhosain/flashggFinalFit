...
f = ROOT.TFile("higgsCombine_scan2D_exp_fa3_ggH_from_AC_HGG_HPlus2Jets.MultiDimFit.mH125.root")
t = f.Get("limit")
...
x, y, deltaNLL = [], [], []
for ev in t:
    x.append( getattr(ev,"fa3_ggH") )
    y.append( getattr(ev,"mu_ggH") )
...
vline = ROOT.TLine(0,y_range[0],0,y_range[1]-yw)
...
canv.Update()
canv.Print("scan2D.png")

#canv.SaveAs("%s/scan_2D.png")
#canv.Print("scan2D.pdf")
