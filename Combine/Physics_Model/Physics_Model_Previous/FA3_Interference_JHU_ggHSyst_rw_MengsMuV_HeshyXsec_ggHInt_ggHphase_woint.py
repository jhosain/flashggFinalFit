...
class FA3_Interference_JHU_ggHSyst_rw_MengsMuV_HeshyXsec_ggHInt_ggHphase(PhysicsModel):
    def doParametersOfInterest(self):
        ...
        self.modelBuilder.doVar("fa3[0.0,0.0,0.001]");            # := a3**2 *sigma3_HZZ / {a3**2 *sigma3_HZZ + a1**2 *sigma1_HZZ}     
        ...
        #self.modelBuilder.factory_('expr::smCoupling_VBF("@0*@1**2)", muVc,a1,a3)'.format(**xsecs))
