...
python RunSignalScripts.py --inputConfig config_sig_$k\_bin_$i.py --mode signalFit  --groupSignalFitJobsByCat --modeOpts "--skipSystematics --replacementThreshold 5 --doPlots --skipVertexScenarioSplit"
