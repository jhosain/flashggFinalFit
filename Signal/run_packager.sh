...
#python RunPlotter.py --procs all --cats "AC_Bin0,AC_Bin1,AC_Bin2,AC_Bin3,AC_Bin4,AC_Bin5,AC_Bin6,AC_Bin7,AC_Bin8,AC_Bin9,AC_Bin10,AC_Bin11,AC_Bin12,AC_Bin13,AC_Bin14,AC_Bin15,AC_Bin16,AC_Bin17,AC_Bin18,AC_Bin19,AC_Bin20,AC_Bin21,AC_Bin22,AC_Bin23,AC_Bin24,AC_Bin25,AC_Bin26,AC_Bin27,AC_Bin28,AC_Bin29" --year $YEAR --ext packaged_$YEAR
...
#cp outdir_packaged_Bin$i/CMS-HGG_sigfit_packaged_Bin$i\_AC_Bin$i.root $InputWSDirPath/Results/Models/signal/CMS-HGG_sigfit_packaged_AC_Bin$i.root
...
mv -if outdir_$YEAR Trees/Opt_$YEAR/$InputWSDirPath/Signal_Output/
...
mv -if outdir_packaged_$YEAR Trees/Opt_$YEAR/$InputWSDirPath/Signal_Output/outdir/

mv -f config_sig_*_$YEAR.py Trees/Opt_$YEAR/$InputWSDirPath/Signal_Output/
