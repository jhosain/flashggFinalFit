...
def get_options():
  ...
  parser.add_option('--year', dest='year', default='2017', help="If not merging then add year tag to file name")
  parser.add_option('--batch', dest='batch', default='local', help='Batch')
