...
merged_signal_bsmmix_weighted = [b0_signal_bsmmix_weighted, b1_signal_bsmmix_weighted, b2_signal_bsmmix_weighted]
...
ax_ratio.set_xlabel("$D_{STXS}^{ggH}$",fontsize=18)
...
plt.savefig('plots_stage03/fa3_%s_D_STXS.png' % opt.out)
plt.show()
