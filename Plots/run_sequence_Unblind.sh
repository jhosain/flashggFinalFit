...
elif [[ $STEP == "doYield" ]]; then
 
python makeSplusBModelPlot.py  --cats all --translateCats cats.json --inputWSFile ../Combine/Datacard_RunII.root  --doSumCategories --doCatWeights --doZeroes --ext fa3_ggH_bsm  --mass 125.38 --unblind --saveWeights  --doYield --parameterMap fa3_ggH:1.  

python makeSplusBModelPlot.py  --cats all --translateCats cats.json --inputWSFile ../Combine/Datacard_RunII.root  --doSumCategories --doCatWeights --doZeroes --ext fa3_ggH_bsmmix  --mass 125.38 --unblind --saveWeights  --doYield --parameterMap fa3_ggH:0.5
